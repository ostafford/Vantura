...
ENV['ENCRYPTION_KEY'] ||= 'test_encryption_key_32_chars_long!!'
# Require Devise before loading Rails environment
require "devise"
...
VCR.configure do |config|
  ...
  config.filter_sensitive_data("<UP_BANK_TOKEN>") do |interaction|
    interaction.request.headers["Authorization"]&.first&.gsub("Bearer ", "")
  end

  # Filter webhook secret from signature header
  config.filter_sensitive_data("<WEBHOOK_SECRET>") do |interaction|
